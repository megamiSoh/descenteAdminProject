...
<div class="warmWrap" id="vList" v-loading="loading">
  ...
  <div class="warm_con">
    ...
    <div class="btnWrap">
        ...
        <router-link v-bind:to="{path: '/marketing/mainBanner'}"><el-button type="warning" size="small" class="submitBtn">취소</el-button></router-link>
    </div>
    </el-form>
...
<script>
import { MainBanner } from '@/api/marketing'
    ...
    data() {
      return {
        ...
        height: 300,
            ...
            filebrowserUploadUrl: 'http://smartshoe-api.azurewebsites.net/api/File/UploadEditor'
      },
        bannerTitle: '',
             ...
             .then(response => {
              this.loading = false
                if(response === undefined) {
                    ...
                    type: 'success'});
                    this.$router.push({ path: '/marketing/mainbanner' })
                }
             })
            })
             .catch(() => {
