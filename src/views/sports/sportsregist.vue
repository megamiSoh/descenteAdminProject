...
<table class="el-table" cellspacing="0" cellpadding="0" >
  ...
  <tr  class="el-table-column">
    ...
    <th>운동 효과</th>
    <td>
      <el-input :max-length="20" v-model="effectInput" size="small"  class="effectStyle"></el-input>
    </td>
  </tr>
  <tr  class="el-table-column">
    <th>운동 강도</th>
              ...
              <el-dialog :visible.sync="onlyShow" >
                        ...
                        <el-form class="searchBoxStyle">
                            ...
                            <el-form size="mini" :inline="true">
                                ...
                                <el-col class="member_btn">
                                    ...
                                    <table class="el-table" stripe align="center">
                                        <colgroup>
                                            <col width="50" />
                                            <col width="100" />
                                            <col width="130" />
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <el-button  @click="onlyShow = true; mediaOpen()" size="small" :disabled="linkMedia()">추가</el-button>
                                    <span v-for="lists in data4" :value="lists.id" :key="lists.id">
                                    {{ lists.originName }}
                                    </span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <el-input :disabled="linkMedia1()" v-model="linkUrl"></el-input>
                        </td>
                    </tr>
                </table>
            </el-form>
            ...
            <td colspan="3" style="width: 100%;">
                ...
                <tr>
                    ...
                    <!--datepicker end-->
                            ...
                            </el-form-item><el-form-item class="member_btn_wrap">
                                <el-col class="member_btn">
                                    <el-button type="info" icon="el-icon-search" @click="getMedia(); pageReset()" size="mini">검색</el-button>
                                </el-col>
                                </el-form-item>
...
<el-dialog
  ...
  <div class="btnWrap">
    <el-button type="info" size="small" class="submitBtn" @click="sportsAdd()">등록</el-button>
...
<script>
import  { AddSports, GetActiveWarmups, Exercises, Cooldowns, GetExerKind, PurposeCategory,IntensityCd, PhotoModels, GetPurposeCategor, GetEffectUnitCd, EncodeVideos, GetVideoMenus, GetWarmupPart } from '@/api/sports'
